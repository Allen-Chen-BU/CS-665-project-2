...
The observer pattern is used in this assignment. As a store need to notify mutiple drivers when a new delivery request is created. To let all the drivers to listen to all the stores waste a large amount of resources. By using the observer pattern, drivers will be notified when a new request is out.
